...
<script>
    $(document).ready(function() {
        ...
        $('#submit-contect-form').on('click', function(e) {
            if ($('#contact-person-name').val() === "" || $('#contact-person-email').val() === "" || $('#contact-person-number').val() === "" || $('#purpose').val() === "") {

                e.preventDefault();
                $('.warning-sen').text('All fields required!');
            }
        });
