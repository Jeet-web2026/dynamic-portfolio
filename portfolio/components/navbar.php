...
<body>
    ...
    <nav class="navbar navbar-expand-lg px-5 bg-dark py-2 fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand text-light fs-2 fw-bold" href="http://localhost/portfolio/">iToDo</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="d-flex align-items-center">
                    <button class="btn btn-info me-2" type="submit" style="border-radius: 0px;">Login</button>
                    <button class="btn btn-success" type="submit" style="border-radius: 0px;">Sign-up</button>
                </div>
            </div>
        </div>
    </nav>
