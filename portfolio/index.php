...
<body id="main-body">
    ...
    <!-- main body section -->
    <main id="body">
        <div class="container-fluid p-lg-5 pt-4 pb-5">
            <div class="row align-items-center px-lg-5">
                ...
                <div class="col-md-7 ps-lg-5 px-2">
    ...
    <section id="card-section">
        <div class="row">
            <div class="col-md-6 p-lg-5 p-3" style="background-color: #212529;">
                <div class="d-lg-flex cstm-side">
                    <div class="card me-lg-5 p-3 mb-3 mb-lg-0" style="border-radius: 0px;">
        ...
        <div class="row second-cards">
            <div class="col-md-6 p-5" style="background-color: #212529;">
                <div class="d-flex justify-content-center align-items-center mt-lg-3">
            ...
            <div class="col-md-6 p-lg-5 p-3">
                <div class="d-lg-flex">
                    <div class="card p-3 me-3 card-width-cstm">
                        <div class="card-body">
                            <?php
                    ...
                    <div class="card p-3 card-width-cstm">
                        <div class="card-body">
                            <?php
    ...
    <!-- card section -->
    <!-- featured projects -->
    <section id="featured-projects" class="p-lg-5 p-3">
        <div class="d-flex justify-content-between align-items-between px-lg-5 px-3">
            <div>
