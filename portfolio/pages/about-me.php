...
<body>
    <main id="body">
        ...
        <div class="container" style="padding-top: 10%;">
            <div class="card first-container" style="width: 100%; border: 2px solid #dc3545; border-radius: 5px; height: 100%;">
                        ...
                        ?>
                            <div class="card ms-3 mt-5" style="border: 2px solid #dc3545; border-radius: 8px;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text mb-2 text-capitalize"><?php echo htmlspecialchars($showData['date']) ?></p>
                                    <p class="card-text text-capitalize"><?php echo htmlspecialchars($showData['name']) ?></p>
                                </div>
                            </div>
                        <?php
                        }
                                ...
                                echo '<div class="px-2">
                                    <div class="card" style="border: 2px solid #dc3545; border-radius: 8px; height: 200px; width: 300px;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text mb-2 text-capitalize">' . $showData['date'] . '</p>
                                            <p class="card-text text-capitalize">' . $showData['name'] . '</p>
                                        </div>
                                    </div>
                                </div>';
                            }
                        ...
                        ?>
                            <div class="card ms-3 mt-5" style="border: 2px solid #dc3545; border-radius: 8px;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text mb-2 text-capitalize"><?php echo htmlspecialchars($showData['date']) ?></p>
                                    <p class="card-text text-capitalize"><?php echo htmlspecialchars($showData['location']) ?></p>
                                </div>
                            </div>
                        <?php
                        }
                                ...
                                echo '<div class="px-2">
                                    <div class="card" style="border: 2px solid #dc3545; border-radius: 8px; height: 200px; width: 300px;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text mb-2 text-capitalize">' . $showData['date'] . '</p>
                                            <p class="card-text text-capitalize">' . $showData['location'] . '</p>
                                        </div>
                                    </div>
                                </div>';
                            }
...
?>
<script>
    $('#body .first-container').css({
        'opacity': '0'
    });
    $('#body .sec-container').css({
        'opacity': '0'
    });
    $('#body .third-container').css({
        'opacity': '0'
    });
    $(document).ready(function() {
        ...
        setTimeout(function() {
            $('#body .first-container').animate({
                opacity: 1
            }, 'slow');
        }, 1205);
        setTimeout(function() {
            $('#body .sec-container').animate({
                opacity: 1
            }, 'slow');
        }, 1300);
        $('#body .third-container').mouseenter(function() {
            $(this).animate({
                opacity: 1
            }, 'slow');
        });
