<?php
include './contents/home-settings.php';
session_start();
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  text-uppercase me-2" href="./contents/about-settings.php">about settings</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  text-uppercase me-2" href="./contents/project-settings.php">Project settings</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  text-uppercase me-2" href="./contents/contact-settings.php">contact page settings</a>
                    </li>
                </ul>
            ...
            <div class="col-sm-6 mb-3 mb-sm-0 pe-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="fw-bold fs-4 mb-0">123456</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.for_delete', function() {
                ...
                $('#confirmDelete').attr('href', `./functions/delete.php?slno=${slno}`);
            });
