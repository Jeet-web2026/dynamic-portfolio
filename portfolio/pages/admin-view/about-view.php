            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-start experienceDate text-truncate" style="max-width: 150px;"><?php echo htmlspecialchars($showData['date']); ?></td>
                        <td class="text-start experienceLocation text-truncate" style="max-width: 150px;"><?php echo htmlspecialchars($showData['location']); ?></td>
                        <td class="text-center">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-start CrntexperienceDate text-truncate" style="max-width: 150px;"><?php echo htmlspecialchars($showData['date']); ?></td>
                        <td class="text-start CrntexperienceLocation text-truncate" style="max-width: 150px;"><?php echo htmlspecialchars($showData['location']); ?></td>
                        <td class="text-center">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-start educationnDate text-truncate" style="max-width: 150px;"><?php echo htmlspecialchars($showData['date']); ?></td>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-start crnteducationnDate text-truncate" style="max-width: 150px;"><?php echo htmlspecialchars($showData['date']); ?></td>
                        <td class="text-start crnteducationnLocation text-truncate" style="max-width: 150px;"><?php echo htmlspecialchars($showData['name']); ?></td>
                        <td class="text-center">
