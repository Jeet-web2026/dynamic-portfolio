            ...
            <tbody>
                ...
                foreach ($viewData as $displayData) {
                    ...
                    echo '<tr>
                            ...
                            <td class="text-center text-capitalize">' . htmlspecialchars($displayData['contact_name']) . '</td>
                            <td class="text-center">' . htmlspecialchars($displayData['contact_email']) . '</td>
                            <td class="text-center text-capitalize">' . htmlspecialchars($displayData['contact_number']) . '</td>
                            <td class="text-center text-capitalize">' . htmlspecialchars($displayData['contact_reason']) . '</td>
                            <td class="text-center">
                                <button type="button" class="btn btn-outline-success" style="border-radius: 0px;">Reply</button>
                                <button type="button" class="btn btn-outline-danger" style="border-radius: 0px;">Delete</button>
                            </td>
                        </tr>';
                }
                ?>
        ...
        <table id="linksTable" class="display">
            ...
            <tbody>
                ...
                foreach ($showData as $displayData) {
                    ...
                    echo '<tr>
                            <td class="text-start">' . $id . '</td>
                            <td class="text-center text-capitalize">' . htmlspecialchars($displayData['link_name']) . '</td>
                            <td class="text-start">' . htmlspecialchars($displayData['links_path']) . '</td>
                            <td class="text-center">
                                <button type="button" class="btn btn-outline-success" style="border-radius: 0px;">Edit</button>
                                <button type="button" class="btn btn-outline-danger" style="border-radius: 0px;">Delete</button>
                            </td>
                        </tr>';
                }
