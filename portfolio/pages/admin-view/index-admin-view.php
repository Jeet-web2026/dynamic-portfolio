...
<body>
    ...
    <!-- my details modal -->
    <div class="modal fade" id="mydetails-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body p-0">
                    <div class="card mb-3 mb-lg-0 w-100 border-0 bg-transparent">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="/portfolio/images/profile.jpg" class="img-fluid rounded-start" alt="profile">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Jit Nath</h5>
                                    <p class="card-text mb-1">Web Application Developer</p>
                                    <p class="card-text mb-1">Garden Reach, Kolkata: 700024</p>
                                    <p class="card-text mb-3">Currently pursuring Bca from Ignou</p>
                                    <div class="d-flex align-items-center">
                                        <a href="tel:+919163715179" class="btn btn-outline-info shadow-none me-3" style="border-radius: 0px;">Call me</a>
                                        <a href="https://wa.me/+919163715179" class="btn btn-outline-success shadow-none" style="border-radius: 0px;">Whatsapp me</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <button type="button" class="btn btn-outline-dark" style="border-radius: 0px;" data-bs-toggle="modal" data-bs-target="#mydetails-modal">Contact me</button>
                            </div>
                        </div>
                    </div>
                </div>
