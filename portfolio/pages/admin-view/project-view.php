...
<body>
    ...
    <div class="modal fade" id="addNewProject" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 0px;">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="/portfolio/pages/functions/add-all-projects.php" method="POST">
                        <div class="mb-3">
                            <label for="addprName" class="form-label">Project Name</label>
                            <input type="text" class="form-control" id="addprName" name="addprName" aria-describedby="emailHelp" style="border-radius: 0px;">
                            <input type="hidden" id="addpr-id" name="addpr-id">
                        </div>
                        <div class="mb-3">
                            <label for="addprDesc" class="form-label">Project Description</label>
                            <input type="text" class="form-control" id="addprDesc" name="addprDesc" aria-describedby="emailHelp" style="border-radius: 0px;">
                        </div>
                        <div class="mb-3">
                            <label for="addprTech" class="form-label">Used Technologis</label>
                            <textarea class="form-control" id="addprTech" name="addprTech" style="height: 100px; border-radius: 0px;"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="addprLink" class="form-label">Project Link</label>
                            <input type="text" class="form-control" id="addprLink" name="addprLink" aria-describedby="emailHelp" style="border-radius: 0px;">
                        </div>
                        <div class="modal-footer justify-content-center">
                            <button type="button" class="btn btn-outline-dark px-3" style="border-radius: 0px;" data-bs-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-outline-success px-3" style="border-radius: 0px;">Save</button>
    ...
    <div class="modal fade" id="addOnGoingProject" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 0px;">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add a ongoing project</h1>
                    <button type="button" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="/portfolio/pages/functions/add-ongoing-projects.php" method="POST">
                        <div class="mb-3">
                            <label for="addOngoingprName" class="form-label">Project Name</label>
                            <input type="text" class="form-control" id="addOngoingprName" name="addOngoingprName" aria-describedby="emailHelp" style="border-radius: 0px;">
                            <input type="hidden" id="addOngoingpr-id" name="addOngoingpr-id">
                        </div>
                        <div class="mb-3">
                            <label for="addOngoingprDesc" class="form-label">Project Description</label>
                            <input type="text" class="form-control" id="addOngoingprDesc" name="addOngoingprDesc" aria-describedby="emailHelp" style="border-radius: 0px;">
                        </div>
                        <div class="mb-3">
                            <label for="addOngoingprTech" class="form-label">Used Technologis</label>
                            <textarea class="form-control" id="addOngoingprTech" name="addOngoingprTech" style="height: 100px; border-radius: 0px;"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="addOngoingprLink" class="form-label">Project Link</label>
                            <input type="text" class="form-control" id="addOngoingprLink" name="addOngoingprLink" aria-describedby="emailHelp" style="border-radius: 0px;">
                        </div>
                        <div class="modal-footer justify-content-center">
                            <button type="button" class="btn btn-outline-dark px-3" style="border-radius: 0px;" data-bs-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-outline-success px-3" style="border-radius: 0px;">Save</button>
    ...
    <!-- Modal 6 -->
    <!-- add recent project modal -->
    <div class="modal fade" id="addRecentProject" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 0px;">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add a recent project</h1>
                    <button type="button" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="/portfolio/pages/functions/add-recent-projects.php" method="POST">
                        <div class="mb-3">
                            <label for="addRecentprName" class="form-label">Project Name</label>
                            <input type="text" class="form-control" id="addRecentprName" name="addRecentprName" aria-describedby="emailHelp" style="border-radius: 0px;">
                        </div>
                        <div class="mb-3">
                            <label for="addRecentprDesc" class="form-label">Project Description</label>
                            <input type="text" class="form-control" id="addRecentprDesc" name="addRecentprDesc" aria-describedby="emailHelp" style="border-radius: 0px;">
                        </div>
                        <div class="mb-3">
                            <label for="addRecentprTech" class="form-label">Used Technologis</label>
                            <textarea class="form-control" id="addRecentprTech" name="addRecentprTech" style="height: 100px; border-radius: 0px;"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="addRecentprLink" class="form-label">Project Link</label>
                            <input type="text" class="form-control" id="addRecentprLink" name="addRecentprLink" aria-describedby="emailHelp" style="border-radius: 0px;">
                        </div>
                        <div class="modal-footer justify-content-center">
                            <button type="button" class="btn btn-outline-dark px-3" style="border-radius: 0px;" data-bs-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-outline-success px-3" style="border-radius: 0px;">Save</button>
    ...
    <section id="admin-dashboard" class="container-fluid">
        ...
        <center>
            <button type="button" class="btn btn-dark fs-5 mt-3" data-bs-toggle="modal" data-bs-target="#addNewProject" style="border-radius: 0px;">Add a new project</button>
        </center>
        ...
        <center>
            <button type="button" class="btn btn-dark fs-5 mt-3" data-bs-toggle="modal" data-bs-target="#addOnGoingProject" style="border-radius: 0px;">Add a ongoing project</button>
        </center>
        ...
        <center>
            <button type="button" class="btn btn-dark fs-5 mt-3" data-bs-toggle="modal" data-bs-target="#addRecentProject" style="border-radius: 0px;">Add a recent project</button>
        </center>
    </section>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-all-projects', function() {
